      ...
      <Paper className={classes.paper}>
        <div className={classes.profile}>
          <div className='image-wrapper'>
            ...
            <Tooltip title="Edit profile picture" placemet="top">
          ...
          <div className="profile-details">
            ...
            {website && (
              <Fragment>
                ...
                <a href={website} target='_blank' rel='website'>{' '} {website}</a>
                <hr />
              </Fragment>
            )}
...
export default connect(mapStateToProps, mapActionsToProps)(widthStyles(styles)(Profile));
